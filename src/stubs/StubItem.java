...
public class StubItem implements Comparable<StubItem>{
     ...
     */
    public StubItem(ArrayList<ArrayList<String>> atributs) {
     ...
     */
    public int getId(){
        return Integer.parseInt(atributs.get(id).get(0));
    }
     ...
     * -1 si implícit < otherItem
     */
    public int compareTo(StubItem otherItem) {
        int id1 = getId();
